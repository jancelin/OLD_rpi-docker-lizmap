...
RUN apt-get -t jessie-backports install -y --force-yes python-simplejson xauth htop nano curl ntp ntpdate \ 
    python-software-properties git wget unzip apache2=2.4.16 apache2-mpm-worker libapache2-mod-fcgid php5 php5-cgi\
    php5-curl php5-cli php5-sqlite php5-gd php5-pgsql libapache2-mod-php5 apache2-mpm-prefork apache2-bin=2.4.16 apache2-data=2.4.16
